...
precedence = (
    ...
    ("right", "is"),
    ("right", "assign"),
    ("right", "increment", "decrement", "self_product", "self_division", "self_integer_division", "self_module",
     "self_power"),
...
def main():
    ...
    parser = yacc.yacc(debug=0, write_tables=0, optimize=1)
    result = parser.parse(content, tracking=True)
    ...
    text += (
        "\n\nThe translated program was saved in the file \"graph.txt\". You can view the content of the file at "
        "www.webgraphviz.com")
    return text
